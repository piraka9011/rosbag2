...
#ifndef ROSBAG2_CPP__SEQUENTIAL_COMPRESSOR_WRITER_HPP_
#define ROSBAG2_CPP__SEQUENTIAL_COMPRESSOR_WRITER_HPP_
...
/**
 * The Writer allows writing messages to a new bag.
 * For every topic, information about its type needs to be added before writing the first message.
 */
...
public:
   ...
   * \param compression_options Options to configure the compressor
   **/
  void open(
...
private:
  ...
  rosbag2_cpp::CompressionMode compression_mode_{CompressionMode::NONE};
...
#endif // ROSBAG2_CPP__SEQUENTIAL_COMPRESSOR_WRITER_HPP_
